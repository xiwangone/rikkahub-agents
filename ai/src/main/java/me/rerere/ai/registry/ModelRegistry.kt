...
object ModelRegistry {
    ...
    val GEMINI_3_1_PRO_PREVIEW_CUSTOMTOOLS =
        defineModel {
    ...
    private val DEEPSEEK_V3_MODEL =
        defineModel {
            tokens("deepseek", "v", "3")
            toolAbility()
        }

    private val DEEPSEEK_CHAT =
        defineModel {
            tokens("deepseek", "chat")
            toolAbility()
        }

    private val DEEPSEEK_V3 =
        defineGroup {
            add(DEEPSEEK_V3_MODEL, DEEPSEEK_CHAT)
        }

    private val DEEPSEEK_R1_MODEL =
        defineModel {
            tokens("deepseek", "r", "1")
            toolReasoningAbility()
        }

    private val DEEPSEEK_REASONER =
        defineModel {
            tokens("deepseek", "reasoner")
            toolReasoningAbility()
        }

    private val DEEPSEEK_V4_FLASH =
        defineModel {
    ...
    private val DEEPSEEK_R1 =
        defineGroup {
            add(DEEPSEEK_R1_MODEL, DEEPSEEK_REASONER)
        }

    private val DEEPSEEK_V3_1 =
        defineModel {
            tokens("deepseek", "v", "3", "1")
            toolReasoningAbility()
        }

    private val DEEPSEEK_V3_2 =
        defineModel {
    ...
    private val QWEN_3_5_MAX =
        defineModel {
            tokens("qwen", "3", "5", "max")
            toolReasoningAbility()
        }

    private val QWEN_3_6_MAX =
        defineModel {
            tokens("qwen", "3", "6", "max")
            toolReasoningAbility()
        }

    private val QWEN_3_7_MAX =
        defineModel {
            tokens("qwen", "3", "7", "max")
            toolReasoningAbility()
        }

    private val DOUBAO_1_6 =
        defineModel {
            tokens("doubao", "1", "6")
            visionInput()
            toolReasoningAbility()
    ...
    private val MINIMAX_M2 =
        defineModel {
            tokens("minimax", "m", "2")
            toolReasoningAbility()
        }

    private val MINIMAX_M2_5 =
        defineModel {
            tokens("minimax", "m", "2", "5")
            toolReasoningAbility()
        }

    private val MINIMAX_M2_7 =
        defineModel {
            tokens("minimax", "m", "2", "7")
            toolReasoningAbility()
        }

    private val MINIMAX_M3 =
        defineModel {
            tokens("minimax", "m", "3")
            visionInput()
            toolReasoningAbility()
    ...
    private val XIAOMI_MIMO_V2 =
        defineModel {
            tokens("mimo", "v", "2")
            toolReasoningAbility()
        }

    private val XIAOMI_MIMO_V2_PRO =
        defineModel {
            tokens("mimo", "v", "2", "pro")
            toolReasoningAbility()
        }

    private val XIAOMI_MIMO_V2_5 =
        defineModel {
            tokens("mimo", "v", "2", "5")
            visionInput()
            toolReasoningAbility()
    ...
    private val XIAOMI_MIMO_V2_5_PRO =
        defineModel {
            tokens("mimo", "v", "2", "5", "pro")
            toolReasoningAbility()
        }

    private val XIAOMI_MIMO_V3 =
        defineModel {
            tokens("mimo", "v", "3")
            visionInput()
            toolReasoningAbility()
    ...
    private val XIAOMI_MIMO_V3_PRO =
        defineModel {
            tokens("mimo", "v", "3", "pro")
            visionInput()
            toolReasoningAbility()
    ...
    private val QWEN_3_8_MAX =
        defineModel {
            tokens("qwen", "3", "8", "max")
            toolReasoningAbility()
        }

    private val ALL_MODELS =
        listOf(
            GPT4O,
            GPT_4_1,
            OPENAI_O_MODELS,
    ...
    val MODEL_INPUT_MODALITIES =
        ModelData { modelId ->
            resolveModalities(modelId) { it.inputModalities }
        }

    val MODEL_OUTPUT_MODALITIES =
        ModelData { modelId ->

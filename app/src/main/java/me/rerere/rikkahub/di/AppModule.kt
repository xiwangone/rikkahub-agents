...
val appModule =
    module {
        ...
        single {
            me.rerere.rikkahub.data.ai.tools.local
                .NfcResultBuffer()
        }
        single {
            me.rerere.rikkahub.data.ai.tools.local
                .SafPickerResultBuffer()
        }
        single {
            me.rerere.rikkahub.data.storage
                .StorageVolumeGrantStore(get())
        }

        single { ScheduledJobRepository(get<me.rerere.rikkahub.data.db.AppDatabase>().scheduledJobDao()) }
        single {
            me.rerere.rikkahub.data.repository.ScheduledJobRunRepository(
                get<me.rerere.rikkahub.data.db.AppDatabase>().scheduledJobRunDao(),
            )
        }
        single {
            me.rerere.rikkahub.service
        ...
        single {
            me.rerere.rikkahub.browser
                .BrowserPreferences(get())
        }
        single {
            me.rerere.rikkahub.data.preferences
        ...
        single<me.rerere.rikkahub.browser.BrowserScreenshotStreamer> {
            me.rerere.rikkahub.data.telegram
                .TelegramBrowserScreenshotStreamer(get(), get(), get())
        }
        ...
        single<InteractiveToolStreamer> {
            me.rerere.rikkahub.data.telegram
                .TelegramInteractiveToolStreamer(get(), get(), get(), get())
        }
        single {
            me.rerere.rikkahub.data.preferences
        ...
        single {
            me.rerere.rikkahub.reliability
        ...
        single {
            me.rerere.rikkahub.workflow.condition
                .ContextProvider(get())
        }
        single {
            me.rerere.rikkahub.workflow.execution
        ...
        single {
            me.rerere.rikkahub.data.keyboard

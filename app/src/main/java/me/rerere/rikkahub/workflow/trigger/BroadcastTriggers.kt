...
internal abstract class BaseBroadcastTriggerFamily(
    ...
    abstract fun matchEvent(
        intent: Intent,
        workflows: List<WorkflowDefinition>,
    ): List<Pair<String, TriggerSpec>>
...
internal class WifiTriggerFamily(
    context: Context,
...
internal class BluetoothTriggerFamily(
    context: Context,
    scope: CoroutineScope,
) : BaseBroadcastTriggerFamily(context, scope) {
...
internal class HeadphoneTriggerFamily(
    context: Context,
    scope: CoroutineScope,
) : BaseBroadcastTriggerFamily(context, scope) {
...
internal class PowerTriggerFamily(
    context: Context,
    scope: CoroutineScope,
) : BaseBroadcastTriggerFamily(context, scope) {
...
internal class ScreenTriggerFamily(
    context: Context,
    scope: CoroutineScope,
) : BaseBroadcastTriggerFamily(context, scope) {
    ...
    override fun handles(spec: TriggerSpec): Boolean = spec is TriggerSpec.ScreenOn || spec is TriggerSpec.ScreenOff
